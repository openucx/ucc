...
void ucc_debug_context_destroy(ucc_tl_context_t *tl_context)
{
    ucc_tl_debug_context_t *ctx = ucs_derived_of(tl_context, ucc_tl_debug_context_t);
    free(ctx);
}
