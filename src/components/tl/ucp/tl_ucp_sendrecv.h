...
#define UCC_TL_UCP_MAKE_RECV_TAG(_ucp_tag, _ucp_tag_mask, _tag,     \
                                 _src, _id, _scope_id, _scope) do { \
        ...
        (_ucp_tag) = UCC_TL_UCP_MAKE_TAG((_tag), (_src), (_id),     \
                                         (_scope_id), (_scope));    \
    } while(0)


#define UCC_TL_UCP_CHECK_REQ_STATUS() do {                              \
