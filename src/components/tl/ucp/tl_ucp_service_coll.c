...
void ucc_tl_ucp_service_cleanup(ucc_coll_task_t *coll_task)
{
    switch (coll_task->args.coll_type) {
    case UCC_COLL_TYPE_ALLREDUCE:
        ucc_tl_ucp_allreduce_knomial_finalize(coll_task);
        break;
    default:
        ucc_tl_ucp_coll_finalize(coll_task);
        break;
    }
}
