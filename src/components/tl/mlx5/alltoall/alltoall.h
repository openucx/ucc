...
typedef struct ucc_tl_mlx5_a2a_ctrl {
    union {
        struct {
...
} ucc_tl_mlx5_a2a_ctrl_t;

typedef struct ucc_tl_mlx5_a2a_op {
    ucc_tl_mlx5_a2a_ctrl_t *ctrl;
    ucc_tl_mlx5_a2a_ctrl_t *my_ctrl;
    struct mlx5dv_mkey **   send_mkeys;
    struct mlx5dv_mkey **   recv_mkeys;
    int *                   blocks_sent;
} ucc_tl_mlx5_a2a_op_t;

/* This structure holds resources and data related to the "in-node"
   part of the algorithm. */
typedef struct ucc_tl_mlx5_a2a_node {
    int                  asr_rank;
    ucc_sbgp_t *         sbgp;
    void *               storage;
    ucc_tl_mlx5_a2a_op_t ops[MAX_OUTSTANDING_OPS];
...
typedef struct ucc_tl_mlx5_a2a_net {
    ucc_sbgp_t *      sbgp;
    int               net_size;
    int *             rank_map;
    ...
    a2a_net_ctrl_t *   remote_ctrl;
    uint32_t *         rkeys;
    ucc_tl_mlx5_dci_t *dcis;
} ucc_tl_mlx5_a2a_net_t;
...
enum
{
    TL_MLX5_A2A_STATE_SHMID,
    TL_MLX5_A2A_STATE_EXCHANGE,
};

typedef struct ucc_tl_mlx5_a2a {
    struct ibv_pd *              pd;
    ...
    ucc_tl_mlx5_a2a_node_t       node;
    ucc_tl_mlx5_a2a_net_t        net;
    ...
    struct ibv_wc *              work_completion; // get rit
...
ucc_status_t ucc_tl_mlx5_a2a_init_progress(ucc_tl_mlx5_team_t *team);
void         ucc_tl_mlx5_a2a_cleanup(ucc_tl_mlx5_team_t *team);

static inline ucc_tl_mlx5_a2a_ctrl_t *
ucc_tl_mlx5_get_ctrl(ucc_tl_mlx5_a2a_t *a2a, int op_index, int rank)
{
    ucc_tl_mlx5_a2a_ctrl_t *ctrl = PTR_OFFSET(
        a2a->node.ops[op_index].ctrl, sizeof(ucc_tl_mlx5_a2a_ctrl_t) * rank);
    return ctrl;
}

static inline ucc_tl_mlx5_a2a_ctrl_t *
ucc_tl_mlx5_get_my_ctrl(ucc_tl_mlx5_a2a_t *a2a, int op_index)
{
...
#define OP_SEGMENT_SIZE(_a2a)                                                  \
    (sizeof(ucc_tl_mlx5_a2a_ctrl_t) * (_a2a)->node_size +                      \
