...
static inline struct ibv_qp_ex *tl_mlx5_get_qp_ex(ucc_tl_mlx5_a2a_t *a2a,
                                                  ucc_rank_t         rank)
{
    if (a2a->is_dc) {
...
static inline struct ibv_qp *tl_mlx5_get_qp(ucc_tl_mlx5_a2a_t *a2a,
                                            ucc_rank_t         rank)
{
    if (a2a->is_dc) {
...
send_block_data(ucc_tl_mlx5_a2a_t *a2a, ucc_rank_t rank, uint64_t src_addr,
...
static inline ucc_status_t send_atomic(ucc_tl_mlx5_a2a_t *a2a, ucc_rank_t rank,
                                       void *remote_addr, uint32_t rkey)
{
    ...
    ibv_wr_set_sge(qp_ex, a2a->dummy_bf_mr->lkey,
                   (uint64_t)a2a->dummy_bf_mr->addr, a2a->dummy_bf_mr->length);
    return UCC_OK;
}
