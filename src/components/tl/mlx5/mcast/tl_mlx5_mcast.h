...
typedef struct ucc_tl_mlx5_mcast_p2p_interface_t {
    ucc_tl_mlx5_mcast_p2p_send_nb_fn_t  send_nb;
    ucc_tl_mlx5_mcast_p2p_recv_nb_fn_t  recv_nb;
    ucc_tl_mlx5_mcast_p2p_progress_fn_t progress;
...
typedef struct ucc_tl_mlx5_mcast_lib_config {
    ucc_tl_lib_config_t super;
    int                 use_internal_oob;
} ucc_tl_mlx5_mcast_lib_config_t;
...
typedef struct ucc_tl_mlx5_mcast_lib {
    ucc_tl_lib_t                   super;
    ucc_tl_mlx5_mcast_lib_config_t cfg;
...
typedef struct mcast_ctx_params {
    char    *ib_dev_name;
    bool     print_nack_stats;
    int      timeout;
    int      (*bcast) (void*, void*, int, int);
    int      (*barrier) (void*);
...
struct ucc_tl_mlx5_mcast_coll_comm {
...
typedef struct ucc_tl_mlx5_mcast_coll_comm ucc_tl_mlx5_mcast_coll_comm_t;
...
struct ucc_tl_mlx5_mcast_oob_p2p_context {
    ucc_context_h base_ctx;
    ucc_team_h    base_team;
    int           my_team_rank;
    ucc_subset_t  subset;
};
typedef struct ucc_tl_mlx5_mcast_oob_p2p_context ucc_tl_mlx5_mcast_oob_p2p_context_t;
...
static inline int ucc_tl_mlx5_mcast_post_recv_buffers(ucc_tl_mlx5_mcast_coll_comm_t* comm)
{
