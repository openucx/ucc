                                         ...
                                         ucc_tl_mlx5_mcast_coll_comm_init_spec_t *mcast_conf)
{
    ...
    comm->truly_zero_copy_allgather_enabled = conf_params->truly_zero_copy_allgather_enabled;
    comm->wsize                             = conf_params->wsize;
    comm->max_push_send                     = conf_params->max_push_send;
    comm->mcast_prepost_bucket_size         = conf_params->mcast_prepost_bucket_size;
