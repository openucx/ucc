...
ucc_status_t ucc_tl_cuda_allgather_ring_start(ucc_coll_task_t *task);

ucc_status_t ucc_tl_cuda_allgather_ring_progress(ucc_coll_task_t *task);

ucc_status_t ucc_tl_cuda_allgather_ring_finalize(ucc_coll_task_t *task);
