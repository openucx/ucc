...
UCC_PROFILE_FUNC(ucc_status_t, ucc_collective_init, (coll_args, request, team),
                 ucc_coll_args_t *coll_args, ucc_coll_req_h *request,
                 ucc_team_h team)
{
...
UCC_PROFILE_FUNC(ucc_status_t, ucc_collective_finalize, (request),
