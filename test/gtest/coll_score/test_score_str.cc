...
UCC_TEST_F(test_score_str, check_valid)
{
    ...
    EXPECT_EQ(UCC_OK, ucc_coll_score_alloc_from_str(str.c_str(), &score, 0, NULL, NULL, NULL));
...
UCC_TEST_F(test_score_str, check_invalid)
{
    ...
    EXPECT_NE(UCC_OK, ucc_coll_score_alloc_from_str(str.c_str(), &score, 0, NULL, NULL, NULL));
