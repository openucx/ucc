...
mpirun \
    ...
    -x PATH \
    -x LD_LIBRARY_PATH \
    /opt/nvidia/torch-ucc/src/ucc/build/test/mpi/ucc_test_mpi --mtypes host,cuda --root random:2 --count_bits 32,64 --displ_bits 32,64
...
mpirun \
    ...
    /opt/nvidia/torch-ucc/src/ucc/build/test/mpi/ucc_test_mpi --mtypes cuda --root random:2 --count_bits 32,64 --displ_bits 32,64
