...
#endif
#if !(defined(__CET__) || defined(__coverity_undefine___CET__))
#define __CET__ 3
#endif
...
#define __GXX_RTTI 1
#endif
#if !(defined(__pie__) || defined(__coverity_undefine___pie__))
#define __pie__ 2
#endif
...
#endif
#if !(defined(__HAVE_SPECULATION_SAFE_VALUE) || defined(__coverity_undefine___HAVE_SPECULATION_SAFE_VALUE))
